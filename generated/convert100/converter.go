...
import (
    ...
    pbgearextrinsic "github.com/streamingfast/substreams-gear/pb/sf/substreams/vara/type/v100"
...
func To_Grandpa_SpFinalityGrandpaAppPublic(in any) *pbgear.Grandpa_SpFinalityGrandpaAppPublic {
    out := &pbgear.Grandpa_SpFinalityGrandpaAppPublic{}
    v := in.(registry.Valuable)
    _ = v
...
func To_Grandpa_SpFinalityGrandpaAppSignature(in any) *pbgear.Grandpa_SpFinalityGrandpaAppSignature {
    out := &pbgear.Grandpa_SpFinalityGrandpaAppSignature{}
    v := in.(registry.Valuable)
    _ = v
...
func To_Grandpa_SpFinalityGrandpaEquivocationProof(in any) *pbgear.Grandpa_SpFinalityGrandpaEquivocationProof {
    out := &pbgear.Grandpa_SpFinalityGrandpaEquivocationProof{}
    v := in.(registry.Valuable)
    _ = v
    ...
    // oneOf field Equivocation
    v1 := To_OneOf_Grandpa_SpFinalityGrandpaEquivocationProof_equivocation(v.ValueAt(1))
    reflect.ValueOf(out).Elem().FieldByName("Equivocation").Set(reflect.ValueOf(v1))

    return out //from message
}
    
func To_OneOf_Grandpa_SpFinalityGrandpaEquivocationProof_equivocation (in any) any  {
    variantIn := in.(*registry.VariantWTF)
    param := variantIn.Value
    switch variantIn.VariantByte {
    case 0:
        return &pbgear.Grandpa_SpFinalityGrandpaEquivocationProof_EquivocationPrevote{
        EquivocationPrevote: To_Grandpa_Prevote(param),
        }
    case 1:
        return &pbgear.Grandpa_SpFinalityGrandpaEquivocationProof_EquivocationPrecommit{
        EquivocationPrecommit: To_Grandpa_Precommit(param),
        }
    default:
        panic(fmt.Sprintf("Unknown variant byte: %d", variantIn.VariantByte))
...
func To_Grandpa_TupleFinalityGrandpaPrecommitspFinalityGrandpaAppSignature(in any) *pbgear.Grandpa_TupleFinalityGrandpaPrecommitspFinalityGrandpaAppSignature {
    out := &pbgear.Grandpa_TupleFinalityGrandpaPrecommitspFinalityGrandpaAppSignature{}
    v := in.(registry.Valuable)
    _ = v
...
func To_Grandpa_TupleFinalityGrandpaPrevotespFinalityGrandpaAppSignature(in any) *pbgear.Grandpa_TupleFinalityGrandpaPrevotespFinalityGrandpaAppSignature {
    out := &pbgear.Grandpa_TupleFinalityGrandpaPrevotespFinalityGrandpaAppSignature{}
    v := in.(registry.Valuable)
    _ = v
...
func To_SpCoreBoundedBoundedVecBoundedVec(in any) *pbgear.SpCoreBoundedBoundedVecBoundedVec {
    out := &pbgear.SpCoreBoundedBoundedVecBoundedVec{}
    v := in.(registry.Valuable)
    _ = v
...
func To_SpFinalityGrandpaAppPublic(in any) *pbgear.SpFinalityGrandpaAppPublic {
    out := &pbgear.SpFinalityGrandpaAppPublic{}
    v := in.(registry.Valuable)
    _ = v
