...
func NewMetadataConverter(metadata *substrateTypes.Metadata, logger *zap.Logger, tracer logging.Tracer) *Converter {
	return &Converter{
		logger:   logger,
		tracer:   tracer,
		metadata: metadata,
...
func (c *Converter) Convert() ([]*protobuf.Message, error) {
